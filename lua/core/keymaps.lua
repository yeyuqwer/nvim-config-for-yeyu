...
map("n", "<D-BS>", explorer.delete_current, { silent = true, desc = "Delete file/folder at cursor" })
map("n", "<D-Del>", explorer.delete_current, { silent = true, desc = "Delete file/folder at cursor" })
